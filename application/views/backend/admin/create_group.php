<form class="" action="<?php echo site_url('admin/group_message_custom/create_group') ?>" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-6" style="padding-top: 8px;">
            <input type="text" class="form-control" id="search-area" placeholder="Search here">
        </div>
    </div>
...
<?php
  ...
  for ($i=0; $i < sizeof($user_array); $i++):
    ...
    <table  class="table table-bordered table-striped table-<?php echo $user_array[$i]; ?>">
...
<div class="col-md-4 col-md-offset-4" style="text-align: center;">
  <button type="submit" name="submit" class="btn btn-success btn-md"><?php echo get_phrase('create'); ?></button>
</div>
</form>
