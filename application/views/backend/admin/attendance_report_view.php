...
<div class="row">
    ...
    $query = $this->db->get_where('class', ['vtype' => $vtype]);
    if ($query->num_rows() > 0):
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label class="control-label"
                           style="margin-bottom: 5px;"><?php echo get_phrase('section'); ?></label>
        ...
        <div class="col-md-4" style="text-align: center;">
            <div class="tile-stats tile-gray">
                ...
                <h4 style="color: #696969;">
                    ...
                    : <?php echo get_phrase('section'); ?> <?php echo $section_name; ?><br>
        ...
        <div class="col-md-12">
            <table class="table table-bordered" id="my_table">
                ...
                <tr>
                    ...
                    for ($i = 1; $i <= $days; $i++) {
                        $dayName = date('D', strtotime($sessional_year.'-'.$month.'-'.$i));
                        $style = ($dayName=='Fri') ? 'background-color: #FF0000;color:#fff' :'';
                    ?>
                        <td style="text-align: center;<?=$style?>"><?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?></td>
                    <?php } ?>
