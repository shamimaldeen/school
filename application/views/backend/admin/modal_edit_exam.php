		...
		<div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="padded">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="datepicker form-control" name="end_date" value="<?php echo  date('m/d/Y', $row['exam_end_date']);?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                    </div>
                </div>
                <div class="form-group">
