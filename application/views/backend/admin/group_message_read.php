...
<?php echo form_open(site_url('admin/group_message_custom/send_reply/' . $current_message_thread_code), array('enctype' => 'multipart/form-data')); ?>
<div class="mail-reply" id="recipient">
    <div class="compose-message-editor">
        <textarea row="2" class="form-control count_me" name="message"
                  placeholder="<?php echo get_phrase('write_your_message'); ?>" required></textarea>
    </div>
    <div class="col-md-12">
