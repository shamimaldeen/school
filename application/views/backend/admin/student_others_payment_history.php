<table class="table table-bordered datatable">
	<thead >
        <tr>
            ...
            <th><div><?php echo get_phrase('invoice_type');?></div></th>
    ...
    <tbody>
        <?php
            ...
            $this->db->where_in('invoice.payment_type' , [4,5,6,7]);
...
<script type="text/javascript">
    ...
    function invoice_edit_modal(invoice_id) {
        showAjaxModal('<?php echo site_url('modal/popup/modal_edit_others_invoice/');?>' + invoice_id);
    }

    function invoice_delete_confirm(invoice_id) {
        confirm_modal('<?php echo site_url('admin/invoice/delete_others/');?>' + invoice_id);
    }
