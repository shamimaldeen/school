	...
	<div class="col-md-12">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
            ...
            <tr>
                ...
                <th><div><?php echo get_phrase('course_fee');?></div></th>
            ...
            <?php
            $count = 1;
            foreach ($tuition_payment_data as $row):
                ?>
                <tr>
                    <td><?php echo ($count++); ?></td>
                    <td><?php echo $row->class_name; ?></td>
                    <td><?php echo $row->section_name; ?></td>
                    <td><?php echo number_format($row->tuition_fee, 2); ?></td>
...
<script type="text/javascript">
	...
	function payment_settings_edit_modal(tid) {
        showAjaxModal('<?php echo site_url('modal/popup_payment/popup_edit_tuition_fee_settings/');?>' + tid);
    }

    function payment_settings_delete_confirm(tid) {
        confirm_modal('<?php echo site_url('admin/payment_settings_action/delete_tuition_fee/');?>' + tid);
    }
</script>