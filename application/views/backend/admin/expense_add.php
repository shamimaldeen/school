                ...
                <?php echo form_open(site_url('admin/expense/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php endforeach;?>
                                <option value="99999" style="text-transform: uppercase">OCCASIONAL EXPENSE</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('payment_to');?></label>
