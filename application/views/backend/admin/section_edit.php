			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/sections/edit/'. $row['section_id']) , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="class_id" class="form-control" onchange="return get_subject_by_class(this.value)" required>
                                ...
                                $vtype = $this->session->userdata('vtype');
									...
									foreach($classes as $row2):
                                		...
                                		<option value="<?php echo $row2['class_id'];?>"
                                			<?php if ($row['class_id'] == $row2['class_id']) echo 'selected';?>><?php echo $row2['name'];?>
                                        </option>
                                    <?php
									endforeach;
								?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="subject_id" id="section_subject_holder" data-message-required="<?php echo get_phrase('value_required');?>" required>
                              ...
                              <?php
									$sections = $this->db->get_where('subject', ['vtype'=>$vtype, 'class_id' => $row['class_id']])->result_array();
									foreach($sections as $rowS):
										?>
                                		<option value="<?php echo $rowS['subject_id'];?>"
                                			<?php if ($row['subject_id'] == $rowS['subject_id']) echo 'selected';?>><?php echo $rowS['name'];?>
                                        </option>
                                    <?php
									endforeach;
								?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="shift">
                                ...
                                <option value="Day" <?= $row['shift']== "Day" ? "selected" : "" ?>>Day</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="course_type">
                                ...
                                <option value="1" <?= ($row['course_type']== 1) ? "selected" : "" ?>>Monthly</option>
                                <option value="2" <?= ($row['course_type']== 2) ? "selected" : "" ?>>Course (Contractual)</option>
                            </select>
                        </div>
                    </div>
