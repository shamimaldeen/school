...
<!--        </div>-->
            ...
            <?php echo form_open(site_url('admin/system_settings/time_settings') , array(
                'class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
            ...
            <div class="col-md-6">
                <div class="panel panel-primary" >
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            <?php echo get_phrase('office_time_settings');?>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label  class="col-sm-3 control-label" for="start_time"><?php echo get_phrase('start_time');?></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="start_time"
                                       value="<?php echo $this->db->get_where('settings' , array('type' =>'start_time'))->row()->description;?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-3 control-label" for="end_time"><?php echo get_phrase('end_time');?></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="end_time"
                                       value="<?php echo $this->db->get_where('settings' , array('type' =>'end_time'))->row()->description;?>" required>
                            </div>
                        </div>
