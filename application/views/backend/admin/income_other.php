            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                            <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/income_other_edit/'.$row['invoice_id']);?>');">
                        ...
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo site_url('admin/income_other/delete/'.$row['invoice_id']);?>');">
