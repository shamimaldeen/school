	...
	<div class="col-md-12">
		...
		<div class="tabs-vertical-env">
			...
			<li class="active"><a href="#b-profile" data-toggle="tab">Select A SMS Service</a></li>
				...
				<li>
					<a href="#metro-net-profile" data-toggle="tab">
						Metro Net Settings
						<?php if ($active_sms_service == 'metro_net'):?>
							<span class="badge badge-success"><?php echo get_phrase('active');?></span>
						<?php endif;?>
					</a>
				</li>
			...
			<div class="tab-content">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
							<select name="active_sms_service" class="form-control selectboxit">
                              <option value=""<?php if ($active_sms_service == '') echo 'selected';?> disabled>
                              		<?php echo get_phrase('not_selected');?>
                              	</option>
                        		<option value="clickatell"
                        			<?php if ($active_sms_service == 'clickatell') echo 'selected';?> disabled>
                        				Clickatell
                        		</option>
                        		<option value="twilio"
                        			<?php if ($active_sms_service == 'twilio') echo 'selected';?> disabled>
                        				Twilio
                        		</option>
                                <option value="msg91"
                        			<?php if ($active_sms_service == 'msg91') echo 'selected';?> disabled>
                        				MSG91
                        		</option>
                                <option value="metro_net"
                                    <?php if ($active_sms_service == 'metro_net') echo 'selected';?>>
                                    Metro Net
                                </option>
				...
				<!-- Metro Net settings -->
				<div class="tab-pane" id="metro-net-profile">
					<?php echo form_open(site_url('admin/sms_settings/metro_net'), array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top')); ?>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">API URL</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="sms_api_url"
                                   value="<?php echo $this->db->get_where('settings', array('type' => 'sms_api_url'))->row()->description; ?>" required>
                        </div>
                    </div>
						<div class="form-group">
	                      <label  class="col-sm-3 control-label">API Key</label>
	                      	<div class="col-sm-5">
	                          	<input type="text" class="form-control" name="sms_api_key"
	                            	value="<?php echo $this->db->get_where('settings' , array('type' =>'sms_api_key'))->row()->description;?>" required>
	                      	</div>
	                  	</div>
	                  	<div class="form-group">
	                        <label  class="col-sm-3 control-label"><?php echo get_phrase('sender_ID');?></label>
	                        <div class="col-sm-5">
	                            <input type="text" class="form-control" name="sms_sender_id"
	                                value="<?php echo $this->db->get_where('settings' , array('type' =>'sms_sender_ID'))->row()->description;?>" required>
	                        </div>
	                    </div>
	                    <div class="form-group">
		                    <div class="col-sm-offset-3 col-sm-5">
