<hr />
<?php echo form_open(site_url('admin/get_daily_attendance_report/'));?>
<div class="row">
    ...
    <div class="col-md-3" style="margin-top: 20px;">
        <button type="submit" id = "submit" class="btn btn-info"><?php echo get_phrase('get_attendance_report');?></button>
    </div>
