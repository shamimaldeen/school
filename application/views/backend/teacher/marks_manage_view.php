    ...
    <div class="col-md-12">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th><?php echo get_phrase('c._w');?></th>
                <th><?php echo get_phrase('h._w');?></th>
                <th><?php echo get_phrase('h._writing');?></th>
                <th><?php echo get_phrase('c._t');?></th>
            ...
            foreach($marks_of_students as $row):
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="h_writing_<?php echo $row['mark_id'];?>"
                               value="<?php echo $row['h_writing_marks'];?>"></td>
                    <td><input type="text" class="form-control" name="ct_<?php echo $row['mark_id'];?>"
                               value="<?php echo $row['ct_marks'];?>"></td>
                    <td>
