    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '')
    {
        if ($class_id != '' && $exam_id != '') {
            ...
            foreach($marks_of_students as $row) {
                $marks_all_data = [
                    'mark_obtained'     => $this->input->post('marks_obtained_'.$row['mark_id']),
                    'comment'           => $this->input->post('comment_'.$row['mark_id']),
                    'cw_marks'          => $this->input->post('cw_'.$row['mark_id']),
                    'hw_marks'          => $this->input->post('hw_'.$row['mark_id']),
                    'h_writing_marks'   => $this->input->post('h_writing_'.$row['mark_id']),
                    'ct_marks'          => $this->input->post('ct_'.$row['mark_id']),
                    'vtype'             => $this->session->userdata('vtype')
                ];
...
//        $page_data['date'] = $this->input->post('sel_date');
